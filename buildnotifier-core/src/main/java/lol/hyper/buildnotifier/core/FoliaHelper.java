...
public class FoliaHelper {
     ...
     */
    public FoliaHelper(JavaPlugin plugin, String serverVersion, int paperBuild) {
    ...
    public void check() {
        ...
        try {
            versionData = JSONReader.requestJSON("https://api.papermc.io/v2/projects/folia/versions/" + serverVersion);
            if (versionData == null) {
                pluginLogger.warning("Unable to lookup version data. URL " + "https://api.papermc.io/v2/projects/folia/versions/" + serverVersion);
                return;
            }
